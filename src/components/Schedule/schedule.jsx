...
const scheduleItems = [
  { id: 1, icon: "https://img.icons8.com/external-kmg-design-detailed-outline-kmg-design/64/external-wedding-rings-wedding-kmg-design-detailed-outline-kmg-design.png",
  ...
  { id: 5, icon: "https://img.icons8.com/ios/50/ballroom-dance.png", time: "9:00 PM", description: "Primer Baile" },
  { id: 6, icon: "https://img.icons8.com/ios/50/disco-ball.png", time: "10:00 PM", description: "Empieza la rumba!" },
];
